...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("SigninQuickstart.SignInResultCallback, SigninQuickstart", SignInResultCallback.class, __md_methods);
	}
	...
	public SignInResultCallback ()
	{
		...
		if (getClass () == SignInResultCallback.class)
			mono.android.TypeManager.Activate ("SigninQuickstart.SignInResultCallback, SigninQuickstart", "", this, new java.lang.Object[] {  });
	}
